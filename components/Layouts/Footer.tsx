                ...
                <div className="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            <li className="mb-3 text-lg font-extrabold text-black dark:text-white">Быстрая навигация</li>
                            <li>
                    ...
                    <div>
                        <ul className="flex flex-col gap-3 font-bold">
                            <li className="mb-3 text-lg font-extrabold text-black dark:text-white">Юридическая информация</li>
                            <li>
                    ...
                    <div className="items-center justify-between text-center font-bold dark:text-white md:flex">
                        <div>
                            ...
                            <Link href="/" className="text-primary transition hover:text-secondary">
                                Фабрика 3D Муром 2023
                            </Link>
                        </div>
                        <div>
                            Нужна помощь? Посетите страницу{' '}
