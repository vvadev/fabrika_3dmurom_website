...
const Index = (props: any) => {
    ...
    return (
        <div className="overflow-x-hidden">
            <Head>
                <title>Главная | Фабрика 3D Муром – 3D печать и моделирование</title>
            </Head>
                    ...
                    <div className="flex flex-col items-center gap-7 lg:flex-row">
                        <div className="flex-1 pb-14 pt-14 text-white ltr:text-center rtl:text-center lg:max-w-[558px] lg:pb-52 ltr:lg:text-left rtl:lg:text-right xl:pt-36">
                            <h2 className="text-3xl font-extrabold sm:text-5xl lg:text-[70px] lg:leading-[89px]">
                                Мы помогаем <span className="text-secondary">бизнесу</span>
                            ...
                            <p className="mt-7 text-lg font-semibold">Мы верим, что 3D печать способна вывеси ваши продукты на новый уровень!</p>
            ...
            <section className="py-14 pb-12 lg:py-20">
                <div className="container">
                    <div className="heading text-center">
                        <h6 className="!text-secondary">Команды. Люди. Поддержка</h6>
                        <h4>
                            Партнеры
                            <span className="relative text-primary after:absolute after:inset-x-0 after:bottom-0 after:h-1 after:w-full after:bg-gradient-to-r after:from-primary/10 after:via-primary after:to-primary/10">
                                {' '}
            ...
            <section className="bg-gradient-to-b from-white/[55%] to-transparent py-12 dark:from-white/5 md:py-20">
                <div className="container">
                    <div className="heading text-center">
                        <h6 className="!text-secondary">Наши Услуги</h6>
                        <h4>Мы предоставляем полный цикл создания продукта от прототипа, до готового изделия</h4>
                    </div>
                    ...
                    >
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                            ...
                            <h3 className="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">3D Печать</h3>
                        ...
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                            ...
                            <h3 className="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">3D Моделирование</h3>
                            <p className="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
                        ...
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary sm:!mt-10 lg:!mt-0">
                            ...
                            <h3 className="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">3D Сканирование</h3>
                            <p className="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
            ...
            <section className="bg-[url(/assets/images/marketing/business-owner.jpg)] bg-cover bg-center bg-no-repeat py-14 lg:py-[100px]">
                <div className="container relative">
                    <div className="heading text-center">
                        <h6 className="!text-secondary">Факты о компании</h6>
                        <h4 className="!text-white">
                            Мы гордимся <span className="text-primary">нашей работой</span>
                        </h4>
                    </div>
                    ...
                    <div className="mx-auto grid max-w-[250px] gap-[30px] ltr:text-right rtl:text-left sm:max-w-none sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        >
                            <div className="flex-1">
                                <div className="pb-2.5 text-4xl font-black leading-none transition group-hover:text-black">
                                    <CountUp start={0} end={2} duration={1} suffix="+"></CountUp>
                                </div>
                                <span className="font-semibold text-white transition group-hover:text-black">Года в Бизнесе и Сфере 3D</span>
                            </div>
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <span className="font-bold text-white transition group-hover:text-black">Постоянных Партнеров</span>
                            </div>
                            <div className="shrink-0 text-[#47BDFF] group-hover:text-black">
                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <span className="font-bold text-white transition group-hover:text-black">Довольных Клиентов</span>
                            </div>
                            <div className="shrink-0 text-[#47BDFF] group-hover:text-black">
                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <span className="font-bold text-white transition group-hover:text-black">Выполненных проектов</span>
                            </div>
                            <div className="shrink-0 text-[#47BDFF] group-hover:text-black">
                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-col items-center gap-[30px] lg:flex-row">
                        ...
                        <div>
                            ...
                            <div className="heading mb-0 text-center ltr:sm:text-left rtl:sm:text-right">
                                <h6 className="!text-secondary">Как это работает</h6>
                                <h4>Всего 3 простых шага.</h4>
                            </div>
                            <div className="mt-12 grid grid-cols-3 space-y-7 text-center">
                                <div className="col-span-3 flex">
                                    <div>
                                        ...
                                        <p className="mt-1 text-2xl font-bold">Создание модели</p>
                                    </div>
                                </div>
                                <div className="col-span-3">
                                    <h2 className="text-[70px] font-black leading-[57px] text-primary">2</h2>
                                    <p className="mt-1 text-2xl font-bold">Печать образца</p>
                                </div>
                                <div className="col-span-3 flex justify-end">
                                    <div className="relative">
                                        <span className="absolute inset-x-12 -top-12">
                                            <img src="/assets/images/marketing/shadow-box.svg" alt="" />
                                        </span>
                                        <h2 className="text-[70px] font-black leading-[57px] text-secondary">3</h2>
                                        <p className="mt-1 text-2xl font-bold">Массовое производство</p>
                                    </div>
                                </div>
                            </div>
                        </div>
